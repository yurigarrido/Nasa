...
export function Home() {
  const [astronomicalData, setAstronomicalData] = useState<
    Astronomical.PhotoData | undefined
  >(undefined)
          ...
          <Main>
            <Content>
              <DateContainer>
                <span>
                  ...
                  {isEditDate ? (
                    ...
                    <span>
                      <strong>{moment(currentDate).format('LL')}</strong>{' '}
                      <Button
                        css={{ color: '$cardText' }}
                        onClick={() => {
                          setIsEditDate(true)
              ...
              <img
                ...
                src={astronomicalData.url}
                alt={astronomicalData.title}
              />
              <div>
